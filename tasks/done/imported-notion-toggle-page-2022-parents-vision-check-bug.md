...
The imported Notion page `2022 爸妈视力检查` has a toggle-related rendering or
interaction bug.
...
- [x] Reproduce the bug on `2022 爸妈视力检查` in the `Notion Import` workspace.
...
The current user workspace is stale: `2022年度习惯` still links to the original
URL-encoded Notion export path for `2022 爸妈视力检查`, and the target page hash
`7783c166b1d448379067ef2502c6c013` is missing from that imported workspace.
...
- parent page link to `2022 爸妈视力检查 7783c166b1d448379067ef2502c6c013.html`
