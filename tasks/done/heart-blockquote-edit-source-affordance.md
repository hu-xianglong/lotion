...
Independently verified on 2026-07-22 with the multi-line imported blockquote
fixture. The smoke locates the affordance on the highlighted middle line,
requires it to become visible on hover, activates it, verifies the complete
source markers, and confirms the selected-line state across both viewports.
